...
database_obj = databaseModel("userki910") #43
...
database_obj.create_view()

database_obj.insert_to_Database("User_", ["ID", "name", "rank"], [2, "User", 1]) # a start user

def testing():
    cur, con = database_obj.conect_to_database(database_obj.database_name)
